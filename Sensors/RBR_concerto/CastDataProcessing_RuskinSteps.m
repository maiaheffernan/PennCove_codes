...
[rsk, flagidx] = RSKremoveloops(rsk,'threshold',0.25,'visualize',50); % 0.25 value: minimum speed at which profile must be taken (units: m/s). This is the default rate from Ruskin. 
