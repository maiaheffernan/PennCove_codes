...
subplot(3,1,1)
pcolor(time,z,east'), shading flat, colormap(cmap)
c1 = colorbar;
c1.Label.String = 'east [m/s]';
...
subplot(3,1,2)
pcolor(time,z,north'), shading flat, colormap(cmap)
c2 = colorbar;
c2.Label.String = 'north [m/s]';
...
subplot(3,1,3)
pcolor(time,z,up'), shading flat, colormap(cmap)
c3 = colorbar();
c3.Label.String = 'up [m/s]';
